...
```bash
cd src-tauri && cargo test --workspace   # 129개 — 레이아웃 대수 · 스냅샷 · PTY · VT 코어 · OSC 스캐너 · 셸 통합 · AI 감지 · 링크 검사 · 새 파일 이름
pnpm test                                # 348개 — 마크다운 렌더러/목차/찾기/링크 · 새 파일 · IME · 편집 기록 · 이미지 · 병합/크기 드래그 · 클립보드 · 줄바꿈 · 스크롤 막대 · 배색 대비 · 하이퍼링크
```
